...
import br.manaus.mysoft.acolherbk.services.ProfissaoService;
...
public class ProfissaoController {
    ...
    public ResponseEntity<Object> listar() {
        try {
            List<Profissao> lista = service.listar();
            return ResponseEntity.ok().body(Mapper.preparaProfissao(lista));
        } catch (Exception e) {
